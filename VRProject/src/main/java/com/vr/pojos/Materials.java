...
public String toString() {
	return "Materials [mId=" + mId + ", mcId=" + mcId + ", gId=" + gId + ", aId=" + aId + ", code=" + code + ", mName="
			+ mName + ", image=" + image + ", image3d=" + image3d + ", status=" + status + ", lastModified="
			+ lastModified + ", priority=" + priority + "]";
}
