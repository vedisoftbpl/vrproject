...
public String toString() {
	return "Sites [sId=" + sId + ", instId=" + instId + ", instDate=" + instDate + ", validUpto=" + validUpto
			+ ", siteName=" + siteName + ", address=" + address + ", city=" + city + ", state=" + state + ", country="
			+ country + ", pin=" + pin + ", website=" + website + ", email=" + email + ", contactPerson="
			+ contactPerson + ", designation=" + designation + ", mobile=" + mobile + ", contactEmail=" + contactEmail
			+ ", status=" + status + ", lastModified=" + lastModified + ", lastSyn=" + lastSyn + "]";
}
